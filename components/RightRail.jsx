    ...
    <div className="space-y-4">
      ...
      <div className="rounded-2xl border bg-white p-4 shadow-sm">
        ...
        <div className="mt-3 grid grid-cols-2 gap-2">
          <Link
            href="/?feed=trending"
            className="rounded-xl border px-3 py-2 text-center text-sm hover:bg-gray-50"
          >
            Trending
          </Link>
          <Link
            href="/?feed=latest"
            className="rounded-xl bg-black px-3 py-2 text-center text-sm text-white hover:bg-gray-900"
          >
            Latest
          </Link>
        </div>
        <p className="mt-3 text-xs text-gray-500">
          Trending is simple in MVP. Next: engagement-based trending +
          personalization.
        </p>
      </div>
      ...
      <div className="rounded-2xl border bg-white p-4 shadow-sm">
        ...
        <p className="mt-1 text-xs text-gray-500">
          This area is reserved for Google AdSense. (At least 50% of the right
          panel.)
        </p>
